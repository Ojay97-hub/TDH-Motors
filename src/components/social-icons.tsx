...
/**
 * Resolves a CMS-supplied platform name ("Instagram", "tiktok", …) to its icon.
 * Falls back to a generic external-link glyph for anything unrecognised so an
 * editor typing a new platform never renders a blank space.
 */
export function SocialPlatformIcon({ platform, size = 36 }: { platform?: string; size?: number }) {
